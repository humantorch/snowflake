...
class SnowflakeApp extends React.Component<Props, SnowflakeAppState> {
  ...
  render() {
    return (
      <main>
        <link
          href="https://fonts.googleapis.com/css?family=Muli:200i,400,400i,600,700,800,900|Roboto"
          rel="stylesheet"
        />
        <style jsx global>{`
          body {
        ...
        <div style={{ display: "flex", paddingBottom: "20px" }}>
          <div style={{ flex: 5 }}>
            ...
            <br />
            💙 Modified by:{" "}
            <a href="https://thrillworks.com">Thrillworks Engineering.</a>{" "}
            {/* <br />
            👩‍🔬 Learn about our Soapbox{" "}
            <a
              href="https://docs.google.com/document/d/1aGnE9t48aOCwrr_u0U80ArkcVhA9ANuUw0g_ClWzs8c/"
              target="_blank"
            >
              growth framework
            </a> */}
